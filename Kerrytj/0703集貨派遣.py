...
pg = context.new_page()
pg.add_init_script("delete Object.getPrototypeOf(navigator).webdriver")  # 防偵測
...
while True:
    try:
        ...
        if last_Page != page or last_totalPage != totalPage:
            ...
            address = pg1.frame_locator("#fra_DivDialogCS02M0020_iframe").locator("#txtCOLLECTION_ADDR").input_value()
            address.strip(' ')
            address.strip('　')
            ...
            try:
                ...
                pg1.frame_locator("#fra_DivDialogCS02M0020_iframe").locator("#txtCOLLECTION_AREA").fill(
                    str(address_car))
                pg1.frame_locator("#fra_DivDialogCS02M0020_iframe").locator("#txtCOLLECTION_AREA").select_text()
                print(f"\n 地址：{address}")
                print("\n—————————————————————————\n")
