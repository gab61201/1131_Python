...
while True:
    try:
        ...
        if last_Page != page or last_totalPage != totalPage:
            ...
            pg1.frame_locator("#fra_DivDialogCS02M0020_iframe").locator("#txtCOLLECTION_AREA").fill(str(address_car))
            pg1.frame_locator("#fra_DivDialogCS02M0020_iframe").locator("#txtCOLLECTION_AREA").press("ControlOrMeta+a")
    except:
        page = '0'
        totalPage = '0'
